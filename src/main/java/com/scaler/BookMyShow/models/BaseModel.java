...
public class BaseModel {
    ...
    // ID annotation indicates that it is the PKEY in the table, and the second annotation indicates
    // we want this id field to be autogenerated as and when a new row gets added.
    private Long id;
